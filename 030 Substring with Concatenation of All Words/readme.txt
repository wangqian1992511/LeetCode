...
2. we find that we have cumulate engough this substring before;
3. we find a valid substring not sufficient to reach its number in the dictionary.
...
In case two, we should delete several continuous candidate substrings, until we have just collect engough the present word. At this time, the index of the deleted candidates cannot be used as final answers.
