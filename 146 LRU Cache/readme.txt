...
Moreover, remember that as long as we do not need to maintain the order of the elements in the hash map, we'd better use "unordered_map", since it is faster.